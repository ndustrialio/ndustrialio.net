...
namespace com.ndustrialio.api.http
{
    public class Request
    {
        ...
        public const string BASE_URL = "https://api.ndustrial.io/v1";
        ...
        private Boolean _authorize = true;
         
        public Dictionary<String, String> _params;

        public Request(String uri=null, Dictionary<String, String> parameters=null, object body=null)
        {
            _uri = uri;
            _body = body;
            _params = parameters;
